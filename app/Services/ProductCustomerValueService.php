...
use App\Repositories\ProductCustomerValue\ProductCustomerValueRepository;

class ProductCustomerValueService
{
     //ProductCustomerValue
     protected $productRepo;
     public function __construct(ProductCustomerValueRepository $productRepo)
     {
