...
class ProductPromotionController extends Controller
{
    ...
    public function __construct(
        ...
        SuiteScriptService $suiteScriptService,
        PromotionNetsuiteRepository $promotionNetsuiteRepository
    )
    {
        $this->productPromotionRepository = $productPromotionRepo;
        $this->promotionNetsuiteRepository = $promotionNetsuiteRepository;
        $this->suiteScriptService = $suiteScriptService;
    }
    /**
