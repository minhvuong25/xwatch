    ...
    <div class="bota_news_search_page">
        <div class="container">
            <h1 class="bota_page_title">
                <span>Kết quả tìm kiếm cho từ khóa "{{ $selectedFilters }}"</span>
            </h1>
                ...
                <div class="item">
                    <div class="bota_cate_news_item">
                       <div class="img">
                          ...
                          <img width="270" height="154" class="owl-lazy" data-src="statics/imgs/sale-bentley-800x456_1678785665.jpg" alt="{!! $value->title !!}" src="{{ asset($value->default_image) }}" style="opacity: 1;">
                          </a>
                       </div>
                       <div class="title">
                        <a href="{{ route('web.blog.show', $value->slug) }}" title="{!! $value->title !!}">{!! $value->title !!}       </a>
                       </div>
                       <div class="date">
